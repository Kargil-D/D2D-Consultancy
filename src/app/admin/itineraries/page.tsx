...
import type { AdminItinerary, AdminPackage, Status } from "@/types/admin";
import ItineraryDaysEditor, { newDay } from "@/components/admin/itinerary/ItineraryDaysEditor";
...
function DaysTab({ form, setForm }: { form: Partial<AdminItinerary>; setForm: (p: Partial<AdminItinerary>) => void }) {
  return <ItineraryDaysEditor days={form.days ?? []} onChange={(days) => setForm({ days })} />;
}
